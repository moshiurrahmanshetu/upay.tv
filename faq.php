...
<?php include __DIR__.'/includes/header.php'; ?>
  ...
  <section class="faq-section py-5">
    <div class="container">
      <div class="caption-content text-center mt-4 mb-5">
          ...
          <div class="accordion" id="faqAccordion">
            <div class="accordion-item">
              <h3 class="accordion-header" id="faq1-heading">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#faq1"
                  ...
                  What is UPAY Ad Network?
                </button>
              </h3>
              <div id="faq1" class="accordion-collapse collapse show" aria-labelledby="faq1-heading"
                data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  uPay Ad Network is an all-in-one digital advertising and monetization platform that connects advertisers and publishers. You can run ad campaigns, monetize your traffic, shorten URLs, and even generate QR codes — all from one dashboard.
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item">
              <h3 class="accordion-header" id="faq2-heading">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  How does uPay help publishers earn money?
                </button>
              </h3>
              <div id="faq2" class="accordion-collapse collapse" aria-labelledby="faq2-heading"
                data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  Publishers earn by displaying ads or sharing short links. Each valid impression or click generates revenue, which can be tracked in real-time from your dashboard.
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item">
              <h3 class="accordion-header" id="faq3-heading">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  How do advertisers benefit from UPAY?
                </button>
              </h3>
              <div id="faq3" class="accordion-collapse collapse" aria-labelledby="faq3-heading"
                data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  Advertisers can reach targeted audiences through multiple ad formats. You can set your campaign budget, track performance, and optimize results for maximum ROI.
                </div>
              </div>
            </div>
            <div class="accordion-item">
            ...
            <div class="accordion-item">
              <h3 class="accordion-header" id="faq5-heading">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  Can I use the URL shortener without being a publisher?
                </button>
              </h3>
              <div id="faq5" class="accordion-collapse collapse" aria-labelledby="faq5-heading"
                data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  Yes. The URL shortener and QR code generator are available to everyone. However, registered users get access to analytics and earning opportunities for shared links.
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item">
              ...
              <div id="faq6" class="accordion-collapse collapse" aria-labelledby="faq6-heading"
                data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  You can withdraw your earnings using popular payment gateways supported by uPay. The minimum payout threshold and payment methods vary depending on your region.
                </div>
              </div>
            </div>
